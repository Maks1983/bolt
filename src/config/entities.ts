...
export const subscribedEntities: EntityConfig[] = [
  ...
  // === CAMERAS ===
  {
    ...
    motion_detection: true,
    night_vision: true,
    entity_picture: '/api/camera_proxy/camera.g4_doorbell_pro_poe_high_resolution_channel',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    ...
    motion_detection: true,
    night_vision: false,
    entity_picture: '/api/camera_proxy/camera.g4_bullet_backyard_high_resolution_channel',
    last_updated: new Date().toISOString(),
    available: true
  },

  // === FRONT DOOR CAMERA DETECTION SENSORS ===
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_animal_detected',
    friendly_name: 'Front Door Animal Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_baby_cry_detected',
    friendly_name: 'Front Door Baby Cry Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
    ...
    sensor_type: 'motion',
    camera_entity: 'camera.g4_doorbell_pro_poe_high_resolution_channel',
    detection_type: 'baby_cry',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_co_alarm_detected',
    friendly_name: 'Front Door CO Alarm Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
    ...
    sensor_type: 'smoke',
    camera_entity: 'camera.g4_doorbell_pro_poe_high_resolution_channel',
    detection_type: 'co_alarm',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_doorbell',
    ...
    sensor_type: 'motion',
    camera_entity: 'camera.g4_doorbell_pro_poe_high_resolution_channel',
    detection_type: 'doorbell',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_is_dark',
    friendly_name: 'Front Door Night Mode',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
    ...
    sensor_type: 'motion',
    camera_entity: 'camera.g4_doorbell_pro_poe_high_resolution_channel',
    detection_type: 'night_mode',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_motion',
  ...
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_person_detected',
    friendly_name: 'Front Door Person Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_smoke_alarm_detected',
    friendly_name: 'Front Door Smoke Alarm Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
    ...
    sensor_type: 'smoke',
    camera_entity: 'camera.g4_doorbell_pro_poe_high_resolution_channel',
    detection_type: 'smoke_alarm',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_speaking_detected',
    friendly_name: 'Front Door Speaking Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
    ...
    sensor_type: 'motion',
    camera_entity: 'camera.g4_doorbell_pro_poe_high_resolution_channel',
    detection_type: 'speaking',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_doorbell_pro_poe_vehicle_detected',
    friendly_name: 'Front Door Vehicle Detection',
    device_type: 'binary_sensor',
    room: 'Entrance',
    floor: 'Lower Floor',
    state: 'off',
  ...
  // === BACKYARD CAMERA DETECTION SENSORS ===
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_animal_detected',
    friendly_name: 'Backyard Animal Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
    device_class: 'motion',
    sensor_type: 'motion',
    camera_entity: 'camera.g4_bullet_backyard_high_resolution_channel',
    detection_type: 'animal',
    last_updated: new Date().toISOString(),
    available: true
  },
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_baby_cry_detected',
    friendly_name: 'Backyard Baby Cry Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_co_alarm_detected',
    friendly_name: 'Backyard CO Alarm Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_is_dark',
    friendly_name: 'Backyard Night Mode',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_motion',
    friendly_name: 'Backyard Motion Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  },
  {
    ...
    friendly_name: 'Backyard Person Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_smoke_alarm_detected',
    friendly_name: 'Backyard Smoke Alarm Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_speaking_detected',
    friendly_name: 'Backyard Speaking Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
  ...
  {
    entity_id: 'binary_sensor.g4_bullet_backyard_vehicle_detected',
    friendly_name: 'Backyard Vehicle Detection',
    device_type: 'binary_sensor',
    room: 'Living Room',
    floor: 'Upper Floor',
    state: 'off',
