          ...
          <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-4 border border-emerald-200/50 shadow-sm">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-emerald-900">{totalCameras} active</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-emerald-600">Sensors</span>
                <span className="font-medium text-emerald-900">24 online</span>
              </div>
              <div className="flex justify-between text-sm">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl p-4 border border-amber-200/50 shadow-sm">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium text-amber-900">21.2°C</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-amber-600">Humidity</span>
                <span className="font-medium text-amber-900">52%</span>
              </div>
              <div className="flex justify-between text-sm">
